...
PATTERNS = [
    ...
    },
    {
        ...
        "name_ja": "例示による具体化",
        "description_ja": (
            "ルーブリック自体が 'e.g.' や 'for example' を用いて "
            "採点基準を例示で具体化している箇所を捕捉する。"
        ...
        "description_en": (
            "Detects rubric text that uses illustrative examples "
        ...
        "cues_en": "e.g., for example, for instance",
        "regex": r"e\.g\.|for example|for instance",
    },
    {
        "enabled": False,
