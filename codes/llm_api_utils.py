...
@retry(wait=wait_fixed(45), stop=stop_after_attempt(300),
       before_sleep=lambda retry_state: logging.error(f"Retrying due to error: {retry_state.outcome.exception()}"))
