                                    ...
                                    for monte_carlo_runs in "${MONTE_CARLO_RUNS[@]}"; do
                                        ...
                                        for i in "${!MODEL_NAMES[@]}"; do
                                            ...
                                            nohup python3 evaluate.py \
                                                ...
                                                > "logs/eval_${method}_${optimize_method}_${dataset}_${seed_prompt}_${with_rationale}_train${train_size}_iteration${iteration}_top${top_k}_bs${batch_sizes_tag}_mc${monte_carlo_runs}_${SANITIZED_MODEL_NAME}_trial${TRIAL}.log" 2>&1 &
                                            pids+=($!)
                                        done
