...
This section provides analyses of the rubric changes introduced by our refinement method. \autoref{tab:rubric_comparison} compares word counts and lexical overlap between the seed and refined rubrics for each dataset-model pair. \autoref{fig:pattern_explanation} defines the seven structural patterns used in our regex-based rubric analysis, with representative matched snippets from refined rubrics. \autoref{tab:rubric_pattern_changes} reports the average pattern match counts before and after refinement. \autoref{fig:rubric_pattern_bg_asap_1_google_gemini_3_flash_preview_base_expert_True_train100_iteration5_top3_bs4_8_12_mc4} shows a full refined rubric with detected patterns highlighted.
