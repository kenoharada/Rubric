...
\begin{table*}[t]
  ...
  \begin{tabular}{lccccc}
    ...
    \midrule
    HD-Eval (\citet{liu-etal-2024-hd}) & $\checkmark$ &  &  &  &  \\
...
\midrule
Gemini 3 Flash & Human & 0.613 & 0.440 & 0.657 & 0.270 & 0.610 \\
Gemini 3 Flash & AutoCalibrate & \underline{0.646} & \underline{0.490} & \textbf{0.716} & \underline{0.297} & \underline{0.550} \\
Gemini 3 Flash & \textbf{Ours} & \textbf{0.700} & \textbf{0.540} & \underline{0.716} & \textbf{0.393} & \textbf{0.520} \\
\midrule
GPT-5 mini & Human & \underline{0.358} & \underline{0.350} & \underline{0.533} & \underline{0.148} & \underline{0.780} \\
GPT-5 mini & AutoCalibrate & 0.338 & 0.340 & 0.514 & 0.142 & 0.790 \\
GPT-5 mini & \textbf{Ours} & \textbf{0.537} & \textbf{0.440} & \textbf{0.618} & \textbf{0.239} & \textbf{0.620} \\
\midrule
Qwen3-80B-A3B & Human & 0.575 & 0.270 & \textbf{0.668} & 0.272 & 0.890 \\
Qwen3-80B-A3B & AutoCalibrate & \underline{0.595} & \underline{0.290} & 0.643 & \textbf{0.310} & \underline{0.850} \\
Qwen3-80B-A3B & \textbf{Ours} & \textbf{0.636} & \textbf{0.410} & \underline{0.645} & \underline{0.295} & \textbf{0.660} \\
\bottomrule
\end{tabular}
\end{table*}
...
LLM & Rubric written by & QWK & Accuracy & Spearman & Macro-F1 & MAE \\
\midrule
Gemini 3 Flash & Human & 0.427 & 0.404 & \underline{0.568} & 0.307 & 0.697 \\
Gemini 3 Flash & AutoCalibrate & \underline{0.489} & \underline{0.590} & 0.493 & \underline{0.382} & \underline{0.460} \\
Gemini 3 Flash & \textbf{Ours} & \textbf{0.646} & \textbf{0.680} & \textbf{0.656} & \textbf{0.595} & \textbf{0.330} \\
\midrule
GPT-5 mini & Human & 0.042 & 0.110 & 0.151 & 0.058 & 1.430 \\
GPT-5 mini & AutoCalibrate & \underline{0.390} & \underline{0.410} & \underline{0.396} & \underline{0.231} & \underline{0.620} \\
...
\midrule
Qwen3-80B-A3B & Human & 0.121 & 0.130 & 0.323 & 0.123 & 1.540 \\
Qwen3-80B-A3B & AutoCalibrate & \underline{0.240} & \underline{0.310} & \underline{0.458} & \underline{0.233} & \underline{1.100} \\
Qwen3-80B-A3B & \textbf{Ours} & \textbf{0.473} & \textbf{0.520} & \textbf{0.490} & \textbf{0.402} & \textbf{0.570} \\
\bottomrule
\end{tabular}
\end{table*}
...
LLM & Rubric written by & QWK & Accuracy & Spearman & Macro-F1 & MAE \\
\midrule
Gemini 3 Flash & Human & \textbf{0.574} & \underline{0.690} & \textbf{0.621} & \textbf{0.636} & \underline{0.320} \\
Gemini 3 Flash & AutoCalibrate & 0.510 & 0.650 & 0.528 & 0.591 & 0.360 \\
Gemini 3 Flash & \textbf{Ours} & \underline{0.557} & \textbf{0.720} & \underline{0.568} & \underline{0.630} & \textbf{0.280} \\
\midrule
GPT-5 mini & Human & \underline{0.447} & \underline{0.680} & \underline{0.475} & \underline{0.528} & \underline{0.320} \\
GPT-5 mini & AutoCalibrate & \textbf{0.539} & \textbf{0.730} & \textbf{0.580} & \textbf{0.578} & \textbf{0.270} \\
GPT-5 mini & \textbf{Ours} & 0.348 & 0.650 & 0.367 & 0.493 & 0.360 \\
\midrule
Qwen3-80B-A3B & Human & 0.364 & 0.470 & \textbf{0.476} & 0.423 & 0.560 \\
Qwen3-80B-A3B & AutoCalibrate & \textbf{0.456} & \underline{0.580} & 0.464 & \textbf{0.545} & \underline{0.440} \\
Qwen3-80B-A3B & \textbf{Ours} & \underline{0.452} & \textbf{0.590} & \underline{0.468} & \underline{0.516} & \textbf{0.420} \\
\bottomrule
\end{tabular}
\end{table*}
