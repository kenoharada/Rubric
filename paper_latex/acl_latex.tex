...
Because our iterative refinement procedure incurs computational cost from repeated LLM inference, we prioritize coverage across multiple benchmarks over evaluating multiple prompts or subsets within the same benchmark. For ASAP and ASAP 2.0, we conduct experiments on one subset: ASAP essay set~1 (P1) and the ASAP 2.0 ``Exploring Venus'' subset.
