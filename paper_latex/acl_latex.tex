...
\midrule
Qwen3-80B-A3B & Human & \underline{0.121} & \underline{0.130} & \underline{0.323} & \underline{0.123} & \underline{1.540} \\
Qwen3-80B-A3B & AutoCalibrate & 0.073 & 0.110 & 0.217 & 0.076 & 1.620 \\
Qwen3-80B-A3B & \textbf{Ours} & \textbf{0.213} & \textbf{0.400} & \textbf{0.349} & \textbf{0.234} & \textbf{0.870} \\
\bottomrule
\end{tabular}
...
On ASAP P1 and ASAP 2.0, rubrics refined from the simplest seed consistently outperform the unrefined human expert rubric across all three models, with improvements up to +0.322 QWK (Qwen3-80B-A3B on ASAP P1). On TOEFL11, results are mixed: GPT-5 mini improves by +0.080, while Gemini 3 Flash and Qwen3-80B-A3B show slight degradations ($-$0.082 and $-$0.030, respectively). Overall, these results demonstrate that our method can, in many settings, match or exceed the performance of a carefully authored expert rubric starting from only a minimal specification of the score scale. This substantially reduces the need for manual rubric authoring, as the refinement process can automatically discover effective scoring criteria from a small set of labeled examples.
...
Qwen3-80B-A3B & 0.001 & 0.365 & \cellcolor{gray!20}0.213 \\
\midrule
...
Qwen3-80B-A3B & 0.264 & 0.480 & \textbf{\cellcolor{gray!20}0.664} \\
\midrule
...
Qwen3-80B-A3B & 0.055 & 0.461 & \cellcolor{gray!20}0.474 \\
\bottomrule
\end{tabular}
...
Tables~\ref{tab:asap2} and~\ref{tab:toefl} report the full zero-shot evaluation results on ASAP 2.0 and TOEFL11, respectively, complementing the ASAP P1 results in Table~\ref{tab:asap1}. On ASAP 2.0 (Table~\ref{tab:asap2}), our method achieves the best QWK for GPT-5 mini (0.466) and Qwen3-80B-A3B (0.664), while AutoCalibrate obtains a slightly higher QWK for Gemini 3 Flash (0.651 vs.\ 0.639). On TOEFL11 (Table~\ref{tab:toefl}), results are more mixed: our method achieves the best QWK only for Qwen3-80B-A3B (0.474), while the human rubric remains strongest for GPT-5 mini (0.447) and AutoCalibrate performs best for Gemini 3 Flash (0.597). These results are discussed in detail in \S\ref{sec:main_results}.
...
\midrule
Qwen3-80B-A3B & Human & \underline{0.575} & \underline{0.270} & \textbf{0.668} & \underline{0.272} & \underline{0.890} \\
Qwen3-80B-A3B & AutoCalibrate & 0.544 & \underline{0.270} & 0.577 & 0.259 & 0.950 \\
Qwen3-80B-A3B & \textbf{Ours} & \textbf{0.664} & \textbf{0.510} & \underline{0.657} & \textbf{0.381} & \textbf{0.610} \\
\bottomrule
\end{tabular}
\caption{Zero-shot evaluation results on ASAP 2.0 with expert seed rubrics. Bold and underlined values indicate the best and second-best scores for each model.}
\label{tab:asap2}
\end{table*}
...
\midrule
Qwen3-80B-A3B & Human & 0.364 & 0.470 & \underline{0.471} & 0.344 & 0.530 \\
Qwen3-80B-A3B & AutoCalibrate & \underline{0.428} & \underline{0.570} & 0.454 & \underline{0.533} & \underline{0.460} \\
Qwen3-80B-A3B & \textbf{Ours} & \textbf{0.474} & \textbf{0.610} & \textbf{0.480} & \textbf{0.540} & \textbf{0.390} \\
\bottomrule
\end{tabular}
\caption{Zero-shot evaluation results on TOEFL11 with expert seed rubrics. Bold and underlined values indicate the best and second-best scores for each model.}
\label{tab:toefl}
\end{table*}
...
LLM & Rubric written by & QWK & Accuracy & Spearman & Macro-F1 & MAE \\
\midrule
Gemini 3 Flash & Human & 0.613 & \underline{0.440} & 0.657 & \underline{0.270} & \underline{0.610} \\
Gemini 3 Flash & AutoCalibrate & \textbf{0.651} & \textbf{0.490} & \underline{0.697} & \textbf{0.308} & \textbf{0.540} \\
Gemini 3 Flash & \textbf{Ours} & \underline{0.639} & 0.420 & \textbf{0.754} & 0.226 & 0.620 \\
\midrule
GPT-5 mini & Human & \underline{0.358} & 0.350 & \textbf{0.533} & 0.148 & \textbf{0.780} \\
GPT-5 mini & AutoCalibrate & 0.277 & \underline{0.370} & \underline{0.471} & \underline{0.148} & \underline{0.820} \\
GPT-5 mini & \textbf{Ours} & \textbf{0.398} & \textbf{0.380} & 0.407 & \textbf{0.195} & \textbf{0.780} \\
\midrule
Qwen3-80B-A3B & Human & \textbf{0.575} & \underline{0.270} & \textbf{0.668} & \underline{0.272} & \underline{0.890} \\
Qwen3-80B-A3B & AutoCalibrate & 0.544 & \underline{0.270} & 0.577 & 0.259 & 0.950 \\
Qwen3-80B-A3B & \textbf{Ours} & \underline{0.558} & \textbf{0.340} & \underline{0.603} & \textbf{0.325} & \textbf{0.850} \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table*}[t]
\centering
\caption{Evaluation results for ASAP P1}
\begin{tabular}{llrrrrr}
\toprule
LLM & Rubric written by & QWK & Accuracy & Spearman & Macro-F1 & MAE \\
\midrule
Gemini 3 Flash & Human & 0.427 & \underline{0.404} & 0.568 & \underline{0.307} & \underline{0.697} \\
Gemini 3 Flash & AutoCalibrate & \underline{0.452} & 0.390 & \underline{0.597} & 0.288 & 0.710 \\
Gemini 3 Flash & \textbf{Ours} & \textbf{0.643} & \textbf{0.590} & \textbf{0.624} & \textbf{0.558} & \textbf{0.410} \\
\midrule
GPT-5 mini & Human & 0.042 & 0.110 & 0.151 & 0.058 & 1.430 \\
GPT-5 mini & AutoCalibrate & \underline{0.117} & \underline{0.250} & \underline{0.280} & \underline{0.121} & \underline{1.010} \\
GPT-5 mini & \textbf{Ours} & \textbf{0.429} & \textbf{0.455} & \textbf{0.422} & \textbf{0.274} & \textbf{0.596} \\
\midrule
Qwen3-80B-A3B & Human & \underline{0.121} & \underline{0.130} & \underline{0.323} & \underline{0.123} & \underline{1.540} \\
Qwen3-80B-A3B & AutoCalibrate & 0.073 & 0.110 & 0.217 & 0.076 & 1.620 \\
Qwen3-80B-A3B & \textbf{Ours} & \textbf{0.339} & \textbf{0.470} & \textbf{0.399} & \textbf{0.344} & \textbf{0.730} \\
\bottomrule
\end{tabular}
\end{table*}
...
LLM & Rubric written by & QWK & Accuracy & Spearman & Macro-F1 & MAE \\
\midrule
Gemini 3 Flash & Human & \underline{0.574} & \underline{0.690} & \underline{0.621} & \textbf{0.636} & \underline{0.320} \\
Gemini 3 Flash & AutoCalibrate & \textbf{0.597} & 0.680 & \textbf{0.648} & \underline{0.636} & \underline{0.320} \\
Gemini 3 Flash & \textbf{Ours} & 0.477 & \textbf{0.710} & 0.519 & 0.550 & \textbf{0.290} \\
\midrule
GPT-5 mini & Human & \underline{0.447} & \underline{0.680} & 0.475 & 0.528 & \underline{0.320} \\
GPT-5 mini & AutoCalibrate & 0.419 & 0.620 & \underline{0.482} & \underline{0.542} & 0.410 \\
GPT-5 mini & \textbf{Ours} & \textbf{0.485} & \textbf{0.700} & \textbf{0.509} & \textbf{0.571} & \textbf{0.300} \\
\midrule
Qwen3-80B-A3B & Human & 0.364 & 0.470 & \underline{0.476} & 0.423 & 0.560 \\
Qwen3-80B-A3B & AutoCalibrate & \underline{0.428} & \underline{0.570} & 0.454 & \underline{0.533} & \underline{0.460} \\
Qwen3-80B-A3B & \textbf{Ours} & \textbf{0.499} & \textbf{0.650} & \textbf{0.515} & \textbf{0.573} & \textbf{0.360} \\
\bottomrule
\end{tabular}
\end{table*}
...
\textbf{Dataset} & \textbf{LLM} & \textbf{Simplest} & \textbf{$\Delta$ vs.\ Human} \\
 & & \textbf{+ Ours} & \textbf{Expert} \\
\midrule
ASAP P1 & GPT-5 mini & 0.265 & +0.224 \\
 & Gemini 3 Flash & 0.642 & +0.214 \\
 & Qwen3-80B-A3B & 0.435 & +0.314 \\
\midrule
ASAP 2.0 & GPT-5 mini & 0.370 & +0.012 \\
 & Gemini 3 Flash & 0.669 & +0.056 \\
 & Qwen3-80B-A3B & 0.626 & +0.051 \\
\midrule
TOEFL11 & GPT-5 mini & 0.505 & +0.059 \\
 & Gemini 3 Flash & 0.519 & $-$0.055 \\
 & Qwen3-80B-A3B & 0.524 & +0.160 \\
\bottomrule
\end{tabular}
\end{table}
