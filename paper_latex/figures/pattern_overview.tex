...
\end{tikzpicture}
\caption{Overview of regex-based patterns used to quantify rubric changes through iterative refinement. \textsc{Rule Structure} patterns capture procedural and structural constraints that guide the scoring process; \textsc{Evidence Handling} patterns capture rules governing how evidence quality and quantity are assessed. Each pattern is detected by case-insensitive keyword matching against the rubric text.}
